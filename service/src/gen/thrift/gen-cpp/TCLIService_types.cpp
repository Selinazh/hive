...
TResourceStatus::~TResourceStatus() throw() {
}


void TResourceStatus::__set_resourceName(const std::string& val) {
  this->resourceName = val;
__isset.resourceName = true;
}

void TResourceStatus::__set_resourceType(const std::string& val) {
  this->resourceType = val;
__isset.resourceType = true;
}

void TResourceStatus::__set_usedCapacity(const std::string& val) {
  this->usedCapacity = val;
__isset.usedCapacity = true;
}

void TResourceStatus::__set_maxCapacity(const std::string& val) {
  this->maxCapacity = val;
__isset.maxCapacity = true;
}

uint32_t TResourceStatus::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->resourceType);
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->usedCapacity);
          this->__isset.usedCapacity = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 4:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->maxCapacity);
          this->__isset.maxCapacity = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t TResourceStatus::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TResourceStatus");

  if (this->__isset.resourceName) {
    xfer += oprot->writeFieldBegin("resourceName", ::apache::thrift::protocol::T_STRING, 1);
    xfer += oprot->writeString(this->resourceName);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.resourceType) {
    xfer += oprot->writeFieldBegin("resourceType", ::apache::thrift::protocol::T_STRING, 2);
    xfer += oprot->writeString(this->resourceType);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.usedCapacity) {
    xfer += oprot->writeFieldBegin("usedCapacity", ::apache::thrift::protocol::T_STRING, 3);
    xfer += oprot->writeString(this->usedCapacity);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.maxCapacity) {
    xfer += oprot->writeFieldBegin("maxCapacity", ::apache::thrift::protocol::T_STRING, 4);
    xfer += oprot->writeString(this->maxCapacity);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(TResourceStatus &a, TResourceStatus &b) {
  using ::std::swap;
  swap(a.resourceName, b.resourceName);
  swap(a.resourceType, b.resourceType);
  swap(a.usedCapacity, b.usedCapacity);
  swap(a.maxCapacity, b.maxCapacity);
  swap(a.__isset, b.__isset);
}

TResourceStatus::TResourceStatus(const TResourceStatus& other294) {
  resourceName = other294.resourceName;
  resourceType = other294.resourceType;
  usedCapacity = other294.usedCapacity;
  maxCapacity = other294.maxCapacity;
  __isset = other294.__isset;
}
TResourceStatus& TResourceStatus::operator=(const TResourceStatus& other295) {
  resourceName = other295.resourceName;
  resourceType = other295.resourceType;
  usedCapacity = other295.usedCapacity;
  maxCapacity = other295.maxCapacity;
  __isset = other295.__isset;
  return *this;
}
void TResourceStatus::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TResourceStatus(";
  out << "resourceName="; (__isset.resourceName ? (out << to_string(resourceName)) : (out << "<null>"));
  out << ", " << "resourceType="; (__isset.resourceType ? (out << to_string(resourceType)) : (out << "<null>"));
  out << ", " << "usedCapacity="; (__isset.usedCapacity ? (out << to_string(usedCapacity)) : (out << "<null>"));
  out << ", " << "maxCapacity="; (__isset.maxCapacity ? (out << to_string(maxCapacity)) : (out << "<null>"));
  out << ")";
}


TResourceStatusList::~TResourceStatusList() throw() {
}


void TResourceStatusList::__set_resourcesConsumed(const std::vector<TResourceStatus> & val) {
  this->resourcesConsumed = val;
__isset.resourcesConsumed = true;
}

uint32_t TResourceStatusList::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            this->resourcesConsumed.clear();
            uint32_t _size296;
            ::apache::thrift::protocol::TType _etype299;
            xfer += iprot->readListBegin(_etype299, _size296);
            this->resourcesConsumed.resize(_size296);
            uint32_t _i300;
            for (_i300 = 0; _i300 < _size296; ++_i300)
            {
              xfer += this->resourcesConsumed[_i300].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.resourcesConsumed = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t TResourceStatusList::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TResourceStatusList");

  if (this->__isset.resourcesConsumed) {
    xfer += oprot->writeFieldBegin("resourcesConsumed", ::apache::thrift::protocol::T_LIST, 1);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->resourcesConsumed.size()));
      std::vector<TResourceStatus> ::const_iterator _iter301;
      for (_iter301 = this->resourcesConsumed.begin(); _iter301 != this->resourcesConsumed.end(); ++_iter301)
      {
...
void swap(TResourceStatusList &a, TResourceStatusList &b) {
  using ::std::swap;
  swap(a.resourcesConsumed, b.resourcesConsumed);
  swap(a.__isset, b.__isset);
}

TResourceStatusList::TResourceStatusList(const TResourceStatusList& other302) {
  resourcesConsumed = other302.resourcesConsumed;
  __isset = other302.__isset;
}
TResourceStatusList& TResourceStatusList::operator=(const TResourceStatusList& other303) {
  resourcesConsumed = other303.resourcesConsumed;
  __isset = other303.__isset;
  return *this;
}
void TResourceStatusList::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TResourceStatusList(";
  out << "resourcesConsumed="; (__isset.resourcesConsumed ? (out << to_string(resourcesConsumed)) : (out << "<null>"));
  out << ")";
}


TOperationStatus::~TOperationStatus() throw() {
}


void TOperationStatus::__set_user(const std::string& val) {
  this->user = val;
__isset.user = true;
}

void TOperationStatus::__set_host(const std::string& val) {
  this->host = val;
__isset.host = true;
}

void TOperationStatus::__set_sessionID(const std::string& val) {
  this->sessionID = val;
__isset.sessionID = true;
}

void TOperationStatus::__set_operationHandleID(const std::string& val) {
  this->operationHandleID = val;
__isset.operationHandleID = true;
}

void TOperationStatus::__set_tezSessionID(const std::string& val) {
  this->tezSessionID = val;
__isset.tezSessionID = true;
}

void TOperationStatus::__set_operationStatus(const TOperationState::type val) {
  this->operationStatus = val;
__isset.operationStatus = true;
}

void TOperationStatus::__set_operationType(const TOperationType::type val) {
  this->operationType = val;
__isset.operationType = true;
}

void TOperationStatus::__set_query(const std::string& val) {
  this->query = val;
__isset.query = true;
}

void TOperationStatus::__set_trackingURL(const std::string& val) {
  this->trackingURL = val;
__isset.trackingURL = true;
}

uint32_t TOperationStatus::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->operationHandleID);
          this->__isset.operationHandleID = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 5:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->tezSessionID);
          this->__isset.tezSessionID = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->operationStatus = (TOperationState::type)ecast304;
      ...
      case 7:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->operationType = (TOperationType::type)ecast305;
      ...
      case 9:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->trackingURL);
          this->__isset.trackingURL = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t TOperationStatus::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TOperationStatus");
  ...
  if (this->__isset.operationHandleID) {
    xfer += oprot->writeFieldBegin("operationHandleID", ::apache::thrift::protocol::T_STRING, 4);
    xfer += oprot->writeString(this->operationHandleID);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.tezSessionID) {
    xfer += oprot->writeFieldBegin("tezSessionID", ::apache::thrift::protocol::T_STRING, 5);
    xfer += oprot->writeString(this->tezSessionID);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.operationStatus) {
    xfer += oprot->writeFieldBegin("operationStatus", ::apache::thrift::protocol::T_I32, 6);
    xfer += oprot->writeI32((int32_t)this->operationStatus);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.operationType) {
    xfer += oprot->writeFieldBegin("operationType", ::apache::thrift::protocol::T_I32, 7);
    xfer += oprot->writeI32((int32_t)this->operationType);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.query) {
    xfer += oprot->writeFieldBegin("query", ::apache::thrift::protocol::T_STRING, 8);
    xfer += oprot->writeString(this->query);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.trackingURL) {
    xfer += oprot->writeFieldBegin("trackingURL", ::apache::thrift::protocol::T_STRING, 9);
    xfer += oprot->writeString(this->trackingURL);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(TOperationStatus &a, TOperationStatus &b) {
  using ::std::swap;
  swap(a.user, b.user);
  swap(a.host, b.host);
  swap(a.sessionID, b.sessionID);
  swap(a.operationHandleID, b.operationHandleID);
  swap(a.tezSessionID, b.tezSessionID);
  swap(a.operationStatus, b.operationStatus);
  swap(a.operationType, b.operationType);
  swap(a.query, b.query);
  swap(a.trackingURL, b.trackingURL);
  swap(a.__isset, b.__isset);
}

TOperationStatus::TOperationStatus(const TOperationStatus& other306) {
  user = other306.user;
  host = other306.host;
  sessionID = other306.sessionID;
  operationHandleID = other306.operationHandleID;
  tezSessionID = other306.tezSessionID;
  operationStatus = other306.operationStatus;
  operationType = other306.operationType;
  query = other306.query;
  trackingURL = other306.trackingURL;
  __isset = other306.__isset;
}
TOperationStatus& TOperationStatus::operator=(const TOperationStatus& other307) {
  user = other307.user;
  host = other307.host;
  sessionID = other307.sessionID;
  operationHandleID = other307.operationHandleID;
  tezSessionID = other307.tezSessionID;
  operationStatus = other307.operationStatus;
  operationType = other307.operationType;
  query = other307.query;
  trackingURL = other307.trackingURL;
  __isset = other307.__isset;
  return *this;
}
void TOperationStatus::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TOperationStatus(";
  ...
  out << ", " << "operationHandleID="; (__isset.operationHandleID ? (out << to_string(operationHandleID)) : (out << "<null>"));
  out << ", " << "tezSessionID="; (__isset.tezSessionID ? (out << to_string(tezSessionID)) : (out << "<null>"));
  out << ", " << "operationStatus="; (__isset.operationStatus ? (out << to_string(operationStatus)) : (out << "<null>"));
  ...
  out << ", " << "trackingURL="; (__isset.trackingURL ? (out << to_string(trackingURL)) : (out << "<null>"));
  out << ")";
}


TActiveOperations::~TActiveOperations() throw() {
}


void TActiveOperations::__set_activeOperations(const std::vector<TOperationStatus> & val) {
  this->activeOperations = val;
__isset.activeOperations = true;
}

uint32_t TActiveOperations::read(::apache::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->activeOperations.resize(_size308);
            uint32_t _i312;
            for (_i312 = 0; _i312 < _size308; ++_i312)
            {
              xfer += this->activeOperations[_i312].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.activeOperations = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t TActiveOperations::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TActiveOperations");

  if (this->__isset.activeOperations) {
    xfer += oprot->writeFieldBegin("activeOperations", ::apache::thrift::protocol::T_LIST, 1);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->activeOperations.size()));
      std::vector<TOperationStatus> ::const_iterator _iter313;
      for (_iter313 = this->activeOperations.begin(); _iter313 != this->activeOperations.end(); ++_iter313)
      {
...
void swap(TActiveOperations &a, TActiveOperations &b) {
  using ::std::swap;
  swap(a.activeOperations, b.activeOperations);
  swap(a.__isset, b.__isset);
}

TActiveOperations::TActiveOperations(const TActiveOperations& other314) {
  activeOperations = other314.activeOperations;
  __isset = other314.__isset;
}
TActiveOperations& TActiveOperations::operator=(const TActiveOperations& other315) {
  activeOperations = other315.activeOperations;
  __isset = other315.__isset;
  return *this;
}
void TActiveOperations::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TActiveOperations(";
  out << "activeOperations="; (__isset.activeOperations ? (out << to_string(activeOperations)) : (out << "<null>"));
  out << ")";
}


TConfigurationEntry::~TConfigurationEntry() throw() {
}


void TConfigurationEntry::__set_paramName(const std::string& val) {
  this->paramName = val;
}

void TConfigurationEntry::__set_paramValue(const std::string& val) {
  this->paramValue = val;
}

uint32_t TConfigurationEntry::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  bool isset_paramName = false;
  bool isset_paramValue = false;
...
uint32_t TConfigurationEntry::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TConfigurationEntry");
...
void swap(TConfigurationEntry &a, TConfigurationEntry &b) {
  using ::std::swap;
  swap(a.paramName, b.paramName);
  swap(a.paramValue, b.paramValue);
}

TConfigurationEntry::TConfigurationEntry(const TConfigurationEntry& other316) {
  paramName = other316.paramName;
  paramValue = other316.paramValue;
}
TConfigurationEntry& TConfigurationEntry::operator=(const TConfigurationEntry& other317) {
  paramName = other317.paramName;
  paramValue = other317.paramValue;
  return *this;
}
void TConfigurationEntry::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TConfigurationEntry(";
  out << "paramName=" << to_string(paramName);
  out << ", " << "paramValue=" << to_string(paramValue);
  out << ")";
}


TConfigurations::~TConfigurations() throw() {
}


void TConfigurations::__set_entries(const std::vector<TConfigurationEntry> & val) {
  this->entries = val;
__isset.entries = true;
}

uint32_t TConfigurations::read(::apache::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->entries.resize(_size318);
            uint32_t _i322;
            for (_i322 = 0; _i322 < _size318; ++_i322)
            {
              xfer += this->entries[_i322].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t TConfigurations::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TConfigurations");
  ...
  if (this->__isset.entries) {
    xfer += oprot->writeFieldBegin("entries", ::apache::thrift::protocol::T_LIST, 1);
    {
      ...
      std::vector<TConfigurationEntry> ::const_iterator _iter323;
      for (_iter323 = this->entries.begin(); _iter323 != this->entries.end(); ++_iter323)
      {
...
void swap(TConfigurations &a, TConfigurations &b) {
  using ::std::swap;
  swap(a.entries, b.entries);
  swap(a.__isset, b.__isset);
}

TConfigurations::TConfigurations(const TConfigurations& other324) {
  entries = other324.entries;
  __isset = other324.__isset;
}
TConfigurations& TConfigurations::operator=(const TConfigurations& other325) {
  entries = other325.entries;
  __isset = other325.__isset;
  return *this;
}
void TConfigurations::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TConfigurations(";
