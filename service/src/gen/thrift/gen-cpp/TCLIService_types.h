...
class TResourceStatusList;

class TOperationStatus;

class TActiveOperations;
...
typedef struct _TResourceStatus__isset {
  _TResourceStatus__isset() : resourceName(false), resourceType(false), usedCapacity(false), maxCapacity(false) {}
  bool resourceName :1;
  bool resourceType :1;
  bool usedCapacity :1;
  bool maxCapacity :1;
} _TResourceStatus__isset;

class TResourceStatus {
 public:

  TResourceStatus(const TResourceStatus&);
  TResourceStatus& operator=(const TResourceStatus&);
  TResourceStatus() : resourceName(), resourceType(), usedCapacity(), maxCapacity() {
  }

  virtual ~TResourceStatus() throw();
  std::string resourceName;
  std::string resourceType;
  std::string usedCapacity;
  std::string maxCapacity;

  _TResourceStatus__isset __isset;

  void __set_resourceName(const std::string& val);

  void __set_resourceType(const std::string& val);

  void __set_usedCapacity(const std::string& val);

  void __set_maxCapacity(const std::string& val);

  bool operator == (const TResourceStatus & rhs) const
  {
    ...
    if (__isset.resourceType != rhs.__isset.resourceType)
      ...
      return false;
    if (__isset.usedCapacity != rhs.__isset.usedCapacity)
      return false;
    else if (__isset.usedCapacity && !(usedCapacity == rhs.usedCapacity))
      return false;
    if (__isset.maxCapacity != rhs.__isset.maxCapacity)
      return false;
    else if (__isset.maxCapacity && !(maxCapacity == rhs.maxCapacity))
      return false;
    return true;
  }
  bool operator != (const TResourceStatus &rhs) const {
  ...
  bool operator < (const TResourceStatus & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const TResourceStatus& obj)
{
  obj.printTo(out);
  return out;
}

typedef struct _TResourceStatusList__isset {
  _TResourceStatusList__isset() : resourcesConsumed(false) {}
  bool resourcesConsumed :1;
} _TResourceStatusList__isset;

class TResourceStatusList {
 public:

  TResourceStatusList(const TResourceStatusList&);
  TResourceStatusList& operator=(const TResourceStatusList&);
  TResourceStatusList() {
  }

  virtual ~TResourceStatusList() throw();
  std::vector<TResourceStatus>  resourcesConsumed;

  _TResourceStatusList__isset __isset;

  void __set_resourcesConsumed(const std::vector<TResourceStatus> & val);

  bool operator == (const TResourceStatusList & rhs) const
  {
    if (__isset.resourcesConsumed != rhs.__isset.resourcesConsumed)
      return false;
    else if (__isset.resourcesConsumed && !(resourcesConsumed == rhs.resourcesConsumed))
      return false;
    return true;
  }
  bool operator != (const TResourceStatusList &rhs) const {
  ...
  bool operator < (const TResourceStatusList & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const TResourceStatusList& obj)
{
  obj.printTo(out);
  return out;
}

typedef struct _TOperationStatus__isset {
  _TOperationStatus__isset() : user(false), host(false), sessionID(false), operationHandleID(false), tezSessionID(false), operationStatus(false), operationType(false), query(false), trackingURL(false) {}
  bool user :1;
  bool host :1;
  bool sessionID :1;
  bool operationHandleID :1;
  bool tezSessionID :1;
  bool operationStatus :1;
  bool operationType :1;
  bool query :1;
  bool trackingURL :1;
} _TOperationStatus__isset;

class TOperationStatus {
 public:

  TOperationStatus(const TOperationStatus&);
  TOperationStatus& operator=(const TOperationStatus&);
  TOperationStatus() : user(), host(), sessionID(), operationHandleID(), tezSessionID(), operationStatus((TOperationState::type)0), operationType((TOperationType::type)0), query(), trackingURL() {
  }

  virtual ~TOperationStatus() throw();
  std::string user;
  std::string host;
  std::string sessionID;
  std::string operationHandleID;
  std::string tezSessionID;
  TOperationState::type operationStatus;
  TOperationType::type operationType;
  std::string query;
  std::string trackingURL;

  _TOperationStatus__isset __isset;
  ...
  void __set_operationHandleID(const std::string& val);

  void __set_tezSessionID(const std::string& val);

  void __set_operationStatus(const TOperationState::type val);

  void __set_operationType(const TOperationType::type val);

  void __set_query(const std::string& val);

  void __set_trackingURL(const std::string& val);

  bool operator == (const TOperationStatus & rhs) const
  {
    ...
    if (__isset.sessionID != rhs.__isset.sessionID)
      ...
      return false;
    if (__isset.operationHandleID != rhs.__isset.operationHandleID)
      return false;
    else if (__isset.operationHandleID && !(operationHandleID == rhs.operationHandleID))
      return false;
    if (__isset.tezSessionID != rhs.__isset.tezSessionID)
      return false;
    else if (__isset.tezSessionID && !(tezSessionID == rhs.tezSessionID))
      return false;
    if (__isset.operationStatus != rhs.__isset.operationStatus)
      return false;
    else if (__isset.operationStatus && !(operationStatus == rhs.operationStatus))
      return false;
    ...
    if (__isset.query != rhs.__isset.query)
      ...
      return false;
    if (__isset.trackingURL != rhs.__isset.trackingURL)
      return false;
    else if (__isset.trackingURL && !(trackingURL == rhs.trackingURL))
      return false;
    return true;
  }
  bool operator != (const TOperationStatus &rhs) const {
  ...
  bool operator < (const TOperationStatus & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const TOperationStatus& obj)
{
  obj.printTo(out);
  return out;
}

typedef struct _TActiveOperations__isset {
  _TActiveOperations__isset() : activeOperations(false) {}
  bool activeOperations :1;
} _TActiveOperations__isset;

class TActiveOperations {
 public:

  TActiveOperations(const TActiveOperations&);
  TActiveOperations& operator=(const TActiveOperations&);
  TActiveOperations() {
  }

  virtual ~TActiveOperations() throw();
  std::vector<TOperationStatus>  activeOperations;

  _TActiveOperations__isset __isset;

  void __set_activeOperations(const std::vector<TOperationStatus> & val);

  bool operator == (const TActiveOperations & rhs) const
  {
    if (__isset.activeOperations != rhs.__isset.activeOperations)
      return false;
    else if (__isset.activeOperations && !(activeOperations == rhs.activeOperations))
      return false;
    return true;
  }
  bool operator != (const TActiveOperations &rhs) const {
  ...
  bool operator < (const TActiveOperations & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const TActiveOperations& obj)
{
  obj.printTo(out);
  return out;
}
...
class TConfigurationEntry {
 public:
  ...
  TConfigurationEntry(const TConfigurationEntry&);
  TConfigurationEntry& operator=(const TConfigurationEntry&);
  TConfigurationEntry() : paramName(), paramValue() {
  }

  virtual ~TConfigurationEntry() throw();
  ...
  bool operator == (const TConfigurationEntry & rhs) const
  {
  ...
  bool operator < (const TConfigurationEntry & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const TConfigurationEntry& obj)
{
  obj.printTo(out);
  return out;
}

typedef struct _TConfigurations__isset {
  _TConfigurations__isset() : entries(false) {}
  bool entries :1;
} _TConfigurations__isset;

class TConfigurations {
 public:

  TConfigurations(const TConfigurations&);
  TConfigurations& operator=(const TConfigurations&);
  TConfigurations() {
  }

  virtual ~TConfigurations() throw();
  std::vector<TConfigurationEntry>  entries;

  _TConfigurations__isset __isset;

  void __set_entries(const std::vector<TConfigurationEntry> & val);

  bool operator == (const TConfigurations & rhs) const
  {
  ...
  bool operator < (const TConfigurations & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const TConfigurations& obj)
{
  obj.printTo(out);
  return out;
}
