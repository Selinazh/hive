...
class TCLIServiceIf {
 public:
  ...
  virtual void GetResourceConsumptionList(TResourceStatusList& _return) = 0;
  virtual void GetActiveOperations(TActiveOperations& _return) = 0;
  virtual void GetConfigurations(TConfigurations& _return) = 0;
  virtual void GetStacks(std::string& _return) = 0;
};
...
class TCLIServiceNull : virtual public TCLIServiceIf {
 public:
  ...
  void GetResourceConsumptionList(TResourceStatusList& /* _return */) {
    return;
  }
  void GetActiveOperations(TActiveOperations& /* _return */) {
    return;
  }
  void GetConfigurations(TConfigurations& /* _return */) {
    return;
  }
  void GetStacks(std::string& /* _return */) {
    return;
  }
};
...
class TCLIService_GetResourceConsumptionList_args {
 public:

  TCLIService_GetResourceConsumptionList_args(const TCLIService_GetResourceConsumptionList_args&);
  TCLIService_GetResourceConsumptionList_args& operator=(const TCLIService_GetResourceConsumptionList_args&);
  TCLIService_GetResourceConsumptionList_args() {
  }

  virtual ~TCLIService_GetResourceConsumptionList_args() throw();

  bool operator == (const TCLIService_GetResourceConsumptionList_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const TCLIService_GetResourceConsumptionList_args &rhs) const {
  ...
  bool operator < (const TCLIService_GetResourceConsumptionList_args & ) const;
...
class TCLIService_GetResourceConsumptionList_pargs {
 public:


  virtual ~TCLIService_GetResourceConsumptionList_pargs() throw();

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _TCLIService_GetResourceConsumptionList_result__isset {
  _TCLIService_GetResourceConsumptionList_result__isset() : success(false) {}
  bool success :1;
} _TCLIService_GetResourceConsumptionList_result__isset;

class TCLIService_GetResourceConsumptionList_result {
 public:

  TCLIService_GetResourceConsumptionList_result(const TCLIService_GetResourceConsumptionList_result&);
  TCLIService_GetResourceConsumptionList_result& operator=(const TCLIService_GetResourceConsumptionList_result&);
  TCLIService_GetResourceConsumptionList_result() {
  }

  virtual ~TCLIService_GetResourceConsumptionList_result() throw();
  TResourceStatusList success;

  _TCLIService_GetResourceConsumptionList_result__isset __isset;

  void __set_success(const TResourceStatusList& val);

  bool operator == (const TCLIService_GetResourceConsumptionList_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const TCLIService_GetResourceConsumptionList_result & ) const;
...
typedef struct _TCLIService_GetResourceConsumptionList_presult__isset {
  _TCLIService_GetResourceConsumptionList_presult__isset() : success(false) {}
  bool success :1;
} _TCLIService_GetResourceConsumptionList_presult__isset;

class TCLIService_GetResourceConsumptionList_presult {
 public:


  virtual ~TCLIService_GetResourceConsumptionList_presult() throw();
  TResourceStatusList* success;

  _TCLIService_GetResourceConsumptionList_presult__isset __isset;
...
class TCLIService_GetActiveOperations_args {
 public:

  TCLIService_GetActiveOperations_args(const TCLIService_GetActiveOperations_args&);
  TCLIService_GetActiveOperations_args& operator=(const TCLIService_GetActiveOperations_args&);
  TCLIService_GetActiveOperations_args() {
  }

  virtual ~TCLIService_GetActiveOperations_args() throw();

  bool operator == (const TCLIService_GetActiveOperations_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const TCLIService_GetActiveOperations_args &rhs) const {
  ...
  bool operator < (const TCLIService_GetActiveOperations_args & ) const;
...
class TCLIService_GetActiveOperations_pargs {
 public:


  virtual ~TCLIService_GetActiveOperations_pargs() throw();

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _TCLIService_GetActiveOperations_result__isset {
  _TCLIService_GetActiveOperations_result__isset() : success(false) {}
  bool success :1;
} _TCLIService_GetActiveOperations_result__isset;

class TCLIService_GetActiveOperations_result {
 public:

  TCLIService_GetActiveOperations_result(const TCLIService_GetActiveOperations_result&);
  TCLIService_GetActiveOperations_result& operator=(const TCLIService_GetActiveOperations_result&);
  TCLIService_GetActiveOperations_result() {
  }

  virtual ~TCLIService_GetActiveOperations_result() throw();
  TActiveOperations success;

  _TCLIService_GetActiveOperations_result__isset __isset;

  void __set_success(const TActiveOperations& val);

  bool operator == (const TCLIService_GetActiveOperations_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const TCLIService_GetActiveOperations_result & ) const;
...
typedef struct _TCLIService_GetActiveOperations_presult__isset {
  _TCLIService_GetActiveOperations_presult__isset() : success(false) {}
  bool success :1;
} _TCLIService_GetActiveOperations_presult__isset;

class TCLIService_GetActiveOperations_presult {
 public:


  virtual ~TCLIService_GetActiveOperations_presult() throw();
  TActiveOperations* success;

  _TCLIService_GetActiveOperations_presult__isset __isset;
...
class TCLIService_GetConfigurations_args {
 public:

  TCLIService_GetConfigurations_args(const TCLIService_GetConfigurations_args&);
  TCLIService_GetConfigurations_args& operator=(const TCLIService_GetConfigurations_args&);
  TCLIService_GetConfigurations_args() {
  }

  virtual ~TCLIService_GetConfigurations_args() throw();

  bool operator == (const TCLIService_GetConfigurations_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const TCLIService_GetConfigurations_args &rhs) const {
  ...
  bool operator < (const TCLIService_GetConfigurations_args & ) const;
...
class TCLIService_GetConfigurations_pargs {
 public:


  virtual ~TCLIService_GetConfigurations_pargs() throw();

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _TCLIService_GetConfigurations_result__isset {
  _TCLIService_GetConfigurations_result__isset() : success(false) {}
  bool success :1;
} _TCLIService_GetConfigurations_result__isset;

class TCLIService_GetConfigurations_result {
 public:

  TCLIService_GetConfigurations_result(const TCLIService_GetConfigurations_result&);
  TCLIService_GetConfigurations_result& operator=(const TCLIService_GetConfigurations_result&);
  TCLIService_GetConfigurations_result() {
  }

  virtual ~TCLIService_GetConfigurations_result() throw();
  TConfigurations success;

  _TCLIService_GetConfigurations_result__isset __isset;

  void __set_success(const TConfigurations& val);

  bool operator == (const TCLIService_GetConfigurations_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const TCLIService_GetConfigurations_result & ) const;
...
typedef struct _TCLIService_GetConfigurations_presult__isset {
  _TCLIService_GetConfigurations_presult__isset() : success(false) {}
  bool success :1;
} _TCLIService_GetConfigurations_presult__isset;

class TCLIService_GetConfigurations_presult {
 public:


  virtual ~TCLIService_GetConfigurations_presult() throw();
  TConfigurations* success;

  _TCLIService_GetConfigurations_presult__isset __isset;
...
class TCLIService_GetStacks_args {
 public:

  TCLIService_GetStacks_args(const TCLIService_GetStacks_args&);
  TCLIService_GetStacks_args& operator=(const TCLIService_GetStacks_args&);
  TCLIService_GetStacks_args() {
  }

  virtual ~TCLIService_GetStacks_args() throw();

  bool operator == (const TCLIService_GetStacks_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const TCLIService_GetStacks_args &rhs) const {
  ...
  bool operator < (const TCLIService_GetStacks_args & ) const;
...
class TCLIService_GetStacks_pargs {
 public:


  virtual ~TCLIService_GetStacks_pargs() throw();

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _TCLIService_GetStacks_result__isset {
  _TCLIService_GetStacks_result__isset() : success(false) {}
  bool success :1;
} _TCLIService_GetStacks_result__isset;

class TCLIService_GetStacks_result {
 public:

  TCLIService_GetStacks_result(const TCLIService_GetStacks_result&);
  TCLIService_GetStacks_result& operator=(const TCLIService_GetStacks_result&);
  TCLIService_GetStacks_result() : success() {
  }

  virtual ~TCLIService_GetStacks_result() throw();
  std::string success;

  _TCLIService_GetStacks_result__isset __isset;

  void __set_success(const std::string& val);

  bool operator == (const TCLIService_GetStacks_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const TCLIService_GetStacks_result & ) const;
...
typedef struct _TCLIService_GetStacks_presult__isset {
  _TCLIService_GetStacks_presult__isset() : success(false) {}
  bool success :1;
} _TCLIService_GetStacks_presult__isset;

class TCLIService_GetStacks_presult {
 public:


  virtual ~TCLIService_GetStacks_presult() throw();
  std::string* success;

  _TCLIService_GetStacks_presult__isset __isset;
...
class TCLIServiceClient : virtual public TCLIServiceIf {
 ...
 public:
  ...
  void GetResourceConsumptionList(TResourceStatusList& _return);
  void send_GetResourceConsumptionList();
  void recv_GetResourceConsumptionList(TResourceStatusList& _return);
  void GetActiveOperations(TActiveOperations& _return);
  void send_GetActiveOperations();
  void recv_GetActiveOperations(TActiveOperations& _return);
  void GetConfigurations(TConfigurations& _return);
  void send_GetConfigurations();
  void recv_GetConfigurations(TConfigurations& _return);
  void GetStacks(std::string& _return);
  void send_GetStacks();
  void recv_GetStacks(std::string& _return);
 protected:
...
class TCLIServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_GetResourceConsumptionList(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_GetActiveOperations(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_GetConfigurations(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_GetStacks(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  TCLIServiceProcessor(boost::shared_ptr<TCLIServiceIf> iface) :
    ...
    processMap_["GetResourceConsumptionList"] = &TCLIServiceProcessor::process_GetResourceConsumptionList;
    processMap_["GetActiveOperations"] = &TCLIServiceProcessor::process_GetActiveOperations;
    processMap_["GetConfigurations"] = &TCLIServiceProcessor::process_GetConfigurations;
    processMap_["GetStacks"] = &TCLIServiceProcessor::process_GetStacks;
  }
...
class TCLIServiceMultiface : virtual public TCLIServiceIf {
 ...
 public:
  ...
  void GetResourceConsumptionList(TResourceStatusList& _return) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->GetResourceConsumptionList(_return);
    }
    ifaces_[i]->GetResourceConsumptionList(_return);
    return;
  }
  ...
  void GetActiveOperations(TActiveOperations& _return) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->GetActiveOperations(_return);
    }
    ifaces_[i]->GetActiveOperations(_return);
    return;
  }
  ...
  void GetConfigurations(TConfigurations& _return) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->GetConfigurations(_return);
    }
    ifaces_[i]->GetConfigurations(_return);
    return;
  }
...
class TCLIServiceConcurrentClient : virtual public TCLIServiceIf {
 ...
 public:
  ...
  void GetResourceConsumptionList(TResourceStatusList& _return);
  int32_t send_GetResourceConsumptionList();
  void recv_GetResourceConsumptionList(TResourceStatusList& _return, const int32_t seqid);
  void GetActiveOperations(TActiveOperations& _return);
  int32_t send_GetActiveOperations();
  void recv_GetActiveOperations(TActiveOperations& _return, const int32_t seqid);
  void GetConfigurations(TConfigurations& _return);
  int32_t send_GetConfigurations();
  void recv_GetConfigurations(TConfigurations& _return, const int32_t seqid);
  void GetStacks(std::string& _return);
  int32_t send_GetStacks();
  void recv_GetStacks(std::string& _return, const int32_t seqid);
 protected:
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
