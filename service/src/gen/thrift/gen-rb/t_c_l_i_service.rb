...
module TCLIService
  class Client
    ...
    def GetResourceConsumptionList()
      send_GetResourceConsumptionList()
      return recv_GetResourceConsumptionList()
    end

    def send_GetResourceConsumptionList()
      send_message('GetResourceConsumptionList', GetResourceConsumptionList_args)
    end

    def recv_GetResourceConsumptionList()
      result = receive_message(GetResourceConsumptionList_result)
      return result.success unless result.success.nil?
      raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'GetResourceConsumptionList failed: unknown result')
    end

    def GetActiveOperations()
      send_GetActiveOperations()
      return recv_GetActiveOperations()
    end

    def send_GetActiveOperations()
      send_message('GetActiveOperations', GetActiveOperations_args)
    end

    def recv_GetActiveOperations()
      result = receive_message(GetActiveOperations_result)
      return result.success unless result.success.nil?
      raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'GetActiveOperations failed: unknown result')
    end
    ...
    def send_GetConfigurations()
      send_message('GetConfigurations', GetConfigurations_args)
    end
    ...
    def send_GetStacks()
      send_message('GetStacks', GetStacks_args)
    end

    def recv_GetStacks()
      result = receive_message(GetStacks_result)
      return result.success unless result.success.nil?
      raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'GetStacks failed: unknown result')
    end
  ...
  class Processor
    ...
    def process_GetResourceConsumptionList(seqid, iprot, oprot)
      args = read_args(iprot, GetResourceConsumptionList_args)
      result = GetResourceConsumptionList_result.new()
      result.success = @handler.GetResourceConsumptionList()
      write_result(result, oprot, 'GetResourceConsumptionList', seqid)
    end

    def process_GetActiveOperations(seqid, iprot, oprot)
      args = read_args(iprot, GetActiveOperations_args)
      result = GetActiveOperations_result.new()
      result.success = @handler.GetActiveOperations()
      write_result(result, oprot, 'GetActiveOperations', seqid)
    end
    ...
    def process_GetConfigurations(seqid, iprot, oprot)
      ...
      result.success = @handler.GetConfigurations()
      write_result(result, oprot, 'GetConfigurations', seqid)
    end

    def process_GetStacks(seqid, iprot, oprot)
      args = read_args(iprot, GetStacks_args)
      result = GetStacks_result.new()
      result.success = @handler.GetStacks()
      write_result(result, oprot, 'GetStacks', seqid)
    end
  ...
  class GetResourceConsumptionList_result
    ...
    FIELDS = {
      SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::TResourceStatusList}
    }
  ...
  class GetActiveOperations_result
    ...
    FIELDS = {
      SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::TActiveOperations}
    }
  ...
  class GetConfigurations_result
    ...
    FIELDS = {
      SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::TConfigurations}
    }
