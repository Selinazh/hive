...
class TResourceStatus
  ...
  FIELDS = {
    RESOURCENAME => {:type => ::Thrift::Types::STRING, :name => 'resourceName', :optional => true},
    RESOURCETYPE => {:type => ::Thrift::Types::STRING, :name => 'resourceType', :optional => true},
    USEDCAPACITY => {:type => ::Thrift::Types::STRING, :name => 'usedCapacity', :optional => true},
    MAXCAPACITY => {:type => ::Thrift::Types::STRING, :name => 'maxCapacity', :optional => true}
  }
...
class TResourceStatusList
  ...
  FIELDS = {
    RESOURCESCONSUMED => {:type => ::Thrift::Types::LIST, :name => 'resourcesConsumed', :element => {:type => ::Thrift::Types::STRUCT, :class => ::TResourceStatus}, :optional => true}
  }
...
class TOperationStatus
  ...
  FIELDS = {
    ...
    SESSIONID => {:type => ::Thrift::Types::STRING, :name => 'sessionID', :optional => true},
    OPERATIONHANDLEID => {:type => ::Thrift::Types::STRING, :name => 'operationHandleID', :optional => true},
    TEZSESSIONID => {:type => ::Thrift::Types::STRING, :name => 'tezSessionID', :optional => true},
    OPERATIONSTATUS => {:type => ::Thrift::Types::I32, :name => 'operationStatus', :optional => true, :enum_class => ::TOperationState},
    OPERATIONTYPE => {:type => ::Thrift::Types::I32, :name => 'operationType', :optional => true, :enum_class => ::TOperationType},
    QUERY => {:type => ::Thrift::Types::STRING, :name => 'query', :optional => true},
    TRACKINGURL => {:type => ::Thrift::Types::STRING, :name => 'trackingURL', :optional => true}
  }

  def struct_fields; FIELDS; end

  def validate
    unless @operationStatus.nil? || ::TOperationState::VALID_VALUES.include?(@operationStatus)
      raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Invalid value of field operationStatus!')
    end
    unless @operationType.nil? || ::TOperationType::VALID_VALUES.include?(@operationType)
      raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Invalid value of field operationType!')
    end
...
class TActiveOperations
  ...
  FIELDS = {
    ACTIVEOPERATIONS => {:type => ::Thrift::Types::LIST, :name => 'activeOperations', :element => {:type => ::Thrift::Types::STRUCT, :class => ::TOperationStatus}, :optional => true}
  }
...
class TConfigurationEntry
  ...
  FIELDS = {
    PARAMNAME => {:type => ::Thrift::Types::STRING, :name => 'paramName'},
    PARAMVALUE => {:type => ::Thrift::Types::STRING, :name => 'paramValue'}
  }

  def struct_fields; FIELDS; end

  def validate
    raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field paramName is unset!') unless @paramName
    raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field paramValue is unset!') unless @paramValue
  end
...
class TConfigurations
  ...
  FIELDS = {
    ENTRIES => {:type => ::Thrift::Types::LIST, :name => 'entries', :element => {:type => ::Thrift::Types::STRUCT, :class => ::TConfigurationEntry}, :optional => true}
  }
