...
public class HiveAuthFactory {
  ...
  public InetAddress getRemoteHost() {
    if (saslServer != null) {
      return saslServer.getRemoteAddress();
    } else {
      return null;
    }
  }
  ...
  public static TServerSocket getServerSocket(String hiveHost, int portNum)
    throws TTransportException {
    return getServerSocket(hiveHost, portNum, false);
  }

  public static TServerSocket getServerSocket(String hiveHost, int portNum, boolean tcpKeepAlive)
      throws TTransportException {
    ...
    return tcpKeepAlive ? new TServerSocketKeepAlive(serverAddress) : new TServerSocket(serverAddress);
  }
