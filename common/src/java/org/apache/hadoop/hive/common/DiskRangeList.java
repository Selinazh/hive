...
public class DiskRangeList extends DiskRange {
  ...
  public static class DiskRangeListCreateHelper {
    ...
    public void addOrMerge(long offset, long end, boolean doMerge, boolean doLogNew) {
      this.addOrMerge(offset, end, doMerge, doLogNew, false);
    }

    public void addOrMerge(long offset, long end, boolean doMerge, boolean doLogNew, boolean skipMergeEmpty) {
      if (skipMergeEmpty && tail != null && tail.offset == tail.end) {
        doMerge = false;
      }
