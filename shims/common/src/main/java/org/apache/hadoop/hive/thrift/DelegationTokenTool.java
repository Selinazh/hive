...
import static org.apache.hadoop.hive.thrift.HadoopThriftAuthBridge.Server.DELEGATION_TOKEN_STORE_CLS;
...
public class DelegationTokenTool extends Configured implements Tool {
  ...
  private void readArgs(String[] args) throws Exception {
    ...
    options.addOption(new Option("confLocation", true, "Location of HCat Server's hive-site."));
  ...
  private void init() throws Exception {
    ...
    delegationTokenStore.init(null, HadoopThriftAuthBridge.Server.ServerMode.METASTORE);
  }
