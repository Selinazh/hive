...
class PartitionValuesRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i375 in xrange(_size371):
            _elem376 = FieldSchema()
            _elem376.read(iprot)
            self.partitionKeys.append(_elem376)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        ...
        if ftype == TType.LIST:
          ...
          for _i381 in xrange(_size377):
            _elem382 = FieldSchema()
            _elem382.read(iprot)
            self.partitionOrder.append(_elem382)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
  ...
  def write(self, oprot):
    ...
    if self.partitionKeys is not None:
      ...
      oprot.writeListBegin(TType.STRUCT, len(self.partitionKeys))
      for iter383 in self.partitionKeys:
        iter383.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.partitionOrder is not None:
      ...
      for iter384 in self.partitionOrder:
        iter384.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class PartitionValuesResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i396 in xrange(_size392):
            _elem397 = PartitionValuesRow()
            _elem397.read(iprot)
            self.partitionValues.append(_elem397)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionValues is not None:
      ...
      for iter398 in self.partitionValues:
        iter398.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class SearchRequest:
  ...
  thrift_spec = (
    ...
    (2, TType.I64, 'maxResults', None, -1, ), # 2
  )

  def __init__(self, query=None, maxResults=thrift_spec[2][4],):
    self.query = query
  ...
  def write(self, oprot):
    ...
    if self.maxResults is not None:
      oprot.writeFieldBegin('maxResults', TType.I64, 2)
...
class Function:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i410 in xrange(_size406):
            _elem411 = ResourceUri()
            _elem411.read(iprot)
            self.resourceUris.append(_elem411)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourceUris is not None:
      ...
      for iter412 in self.resourceUris:
        iter412.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
