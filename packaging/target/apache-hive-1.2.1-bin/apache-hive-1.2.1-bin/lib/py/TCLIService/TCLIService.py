...
class Iface:
  ...
  def GetResourceConsumptionList(self):
    pass

  def GetActiveOperations(self):
    pass
...
class Client(Iface):
  ...
  def GetResourceConsumptionList(self):
    self.send_GetResourceConsumptionList()
    return self.recv_GetResourceConsumptionList()

  def send_GetResourceConsumptionList(self):
    self._oprot.writeMessageBegin('GetResourceConsumptionList', TMessageType.CALL, self._seqid)
    args = GetResourceConsumptionList_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_GetResourceConsumptionList(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = GetResourceConsumptionList_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "GetResourceConsumptionList failed: unknown result")

  def GetActiveOperations(self):
    self.send_GetActiveOperations()
    return self.recv_GetActiveOperations()

  def send_GetActiveOperations(self):
    self._oprot.writeMessageBegin('GetActiveOperations', TMessageType.CALL, self._seqid)
    args = GetActiveOperations_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_GetActiveOperations(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = GetActiveOperations_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "GetActiveOperations failed: unknown result")

  def GetConfigurations(self):
    self.send_GetConfigurations()
    return self.recv_GetConfigurations()

  def send_GetConfigurations(self):
  ...
  def GetStacks(self):
    self.send_GetStacks()
    return self.recv_GetStacks()

  def send_GetStacks(self):
    self._oprot.writeMessageBegin('GetStacks', TMessageType.CALL, self._seqid)
    args = GetStacks_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_GetStacks(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = GetStacks_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "GetStacks failed: unknown result")
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["GetResourceConsumptionList"] = Processor.process_GetResourceConsumptionList
    self._processMap["GetActiveOperations"] = Processor.process_GetActiveOperations
    self._processMap["GetConfigurations"] = Processor.process_GetConfigurations
    self._processMap["GetStacks"] = Processor.process_GetStacks
  ...
  def process_GetResourceConsumptionList(self, seqid, iprot, oprot):
    args = GetResourceConsumptionList_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = GetResourceConsumptionList_result()
    try:
      result.success = self._handler.GetResourceConsumptionList()
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("GetResourceConsumptionList", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_GetActiveOperations(self, seqid, iprot, oprot):
    args = GetActiveOperations_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = GetActiveOperations_result()
    try:
      result.success = self._handler.GetActiveOperations()
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("GetActiveOperations", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_GetConfigurations(self, seqid, iprot, oprot):
    ...
    result = GetConfigurations_result()
    try:
      result.success = self._handler.GetConfigurations()
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
  ...
  def process_GetStacks(self, seqid, iprot, oprot):
    args = GetStacks_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = GetStacks_result()
    try:
      result.success = self._handler.GetStacks()
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("GetStacks", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class GetResourceConsumptionList_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetResourceConsumptionList_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class GetResourceConsumptionList_result:
  """
  Attributes:
   - success
  """
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TResourceStatusList, TResourceStatusList.thrift_spec), None, ), # 0
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = TResourceStatusList()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetResourceConsumptionList_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
...
class GetActiveOperations_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetActiveOperations_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class GetActiveOperations_result:
  """
  Attributes:
   - success
  """
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TActiveOperations, TActiveOperations.thrift_spec), None, ), # 0
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = TActiveOperations()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetActiveOperations_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
...
class GetConfigurations_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TConfigurations, TConfigurations.thrift_spec), None, ), # 0
  )
...
class GetStacks_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetStacks_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class GetStacks_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetStacks_result')
    if self.success is not None:
