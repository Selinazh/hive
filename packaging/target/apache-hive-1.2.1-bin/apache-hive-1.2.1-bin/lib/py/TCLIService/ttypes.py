...
class TResourceStatus:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'resourceName', None, None, ), # 1
    (2, TType.STRING, 'resourceType', None, None, ), # 2
    (3, TType.STRING, 'usedCapacity', None, None, ), # 3
    (4, TType.STRING, 'maxCapacity', None, None, ), # 4
  )

  def __init__(self, resourceName=None, resourceType=None, usedCapacity=None, maxCapacity=None,):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.usedCapacity = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.STRING:
          self.maxCapacity = iprot.readString()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TResourceStatus')
    if self.resourceName is not None:
      oprot.writeFieldBegin('resourceName', TType.STRING, 1)
    ...
    if self.usedCapacity is not None:
      oprot.writeFieldBegin('usedCapacity', TType.STRING, 3)
      oprot.writeString(self.usedCapacity)
      oprot.writeFieldEnd()
    if self.maxCapacity is not None:
      oprot.writeFieldBegin('maxCapacity', TType.STRING, 4)
      oprot.writeString(self.maxCapacity)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.maxCapacity)
    return value
...
class TResourceStatusList:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'resourcesConsumed', (TType.STRUCT,(TResourceStatus, TResourceStatus.thrift_spec)), None, ), # 1
  )

  def __init__(self, resourcesConsumed=None,):
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i163 in xrange(_size159):
            _elem164 = TResourceStatus()
            _elem164.read(iprot)
            self.resourcesConsumed.append(_elem164)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TResourceStatusList')
    if self.resourcesConsumed is not None:
      oprot.writeFieldBegin('resourcesConsumed', TType.LIST, 1)
      oprot.writeListBegin(TType.STRUCT, len(self.resourcesConsumed))
      for iter165 in self.resourcesConsumed:
        iter165.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.resourcesConsumed)
    return value
...
class TOperationStatus:
  ...
  thrift_spec = (
    ...
    (4, TType.STRING, 'operationHandleID', None, None, ), # 4
    (5, TType.STRING, 'tezSessionID', None, None, ), # 5
    (6, TType.I32, 'operationStatus', None, None, ), # 6
    (7, TType.I32, 'operationType', None, None, ), # 7
    (8, TType.STRING, 'query', None, None, ), # 8
    (9, TType.STRING, 'trackingURL', None, None, ), # 9
  )

  def __init__(self, user=None, host=None, sessionID=None, operationHandleID=None, tezSessionID=None, operationStatus=None, operationType=None, query=None, trackingURL=None,):
    self.user = user
    self.host = host
    self.sessionID = sessionID
    self.operationHandleID = operationHandleID
    self.tezSessionID = tezSessionID
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.operationHandleID = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.STRING:
          self.tezSessionID = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.I32:
          self.operationStatus = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.I32:
        ...
        if ftype == TType.STRING:
          self.trackingURL = iprot.readString()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TOperationStatus')
    ...
    if self.sessionID is not None:
      ...
      oprot.writeFieldEnd()
    if self.operationHandleID is not None:
      oprot.writeFieldBegin('operationHandleID', TType.STRING, 4)
      oprot.writeString(self.operationHandleID)
      oprot.writeFieldEnd()
    if self.tezSessionID is not None:
      oprot.writeFieldBegin('tezSessionID', TType.STRING, 5)
      oprot.writeString(self.tezSessionID)
      oprot.writeFieldEnd()
    if self.operationStatus is not None:
      oprot.writeFieldBegin('operationStatus', TType.I32, 6)
      oprot.writeI32(self.operationStatus)
      oprot.writeFieldEnd()
    if self.operationType is not None:
      oprot.writeFieldBegin('operationType', TType.I32, 7)
      oprot.writeI32(self.operationType)
      oprot.writeFieldEnd()
    ...
    if self.trackingURL is not None:
      oprot.writeFieldBegin('trackingURL', TType.STRING, 9)
      oprot.writeString(self.trackingURL)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.sessionID)
    value = (value * 31) ^ hash(self.operationHandleID)
    value = (value * 31) ^ hash(self.tezSessionID)
    value = (value * 31) ^ hash(self.operationStatus)
    value = (value * 31) ^ hash(self.operationType)
    value = (value * 31) ^ hash(self.query)
    value = (value * 31) ^ hash(self.trackingURL)
    return value
...
class TActiveOperations:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'activeOperations', (TType.STRUCT,(TOperationStatus, TOperationStatus.thrift_spec)), None, ), # 1
  )

  def __init__(self, activeOperations=None,):
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i170 in xrange(_size166):
            _elem171 = TOperationStatus()
            _elem171.read(iprot)
            self.activeOperations.append(_elem171)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TActiveOperations')
    if self.activeOperations is not None:
      oprot.writeFieldBegin('activeOperations', TType.LIST, 1)
      oprot.writeListBegin(TType.STRUCT, len(self.activeOperations))
      for iter172 in self.activeOperations:
        iter172.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.activeOperations)
    return value
...
class TConfigurationEntry:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'paramName', None, None, ), # 1
    (2, TType.STRING, 'paramValue', None, None, ), # 2
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TConfigurationEntry')
    if self.paramName is not None:
      oprot.writeFieldBegin('paramName', TType.STRING, 1)
      oprot.writeString(self.paramName)
      oprot.writeFieldEnd()
    if self.paramValue is not None:
      oprot.writeFieldBegin('paramValue', TType.STRING, 2)
  ...
  def validate(self):
    if self.paramName is None:
      raise TProtocol.TProtocolException(message='Required field paramName is unset!')
    if self.paramValue is None:
      raise TProtocol.TProtocolException(message='Required field paramValue is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.paramName)
...
class TConfigurations:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'entries', (TType.STRUCT,(TConfigurationEntry, TConfigurationEntry.thrift_spec)), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i177 in xrange(_size173):
            _elem178 = TConfigurationEntry()
            _elem178.read(iprot)
            self.entries.append(_elem178)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
