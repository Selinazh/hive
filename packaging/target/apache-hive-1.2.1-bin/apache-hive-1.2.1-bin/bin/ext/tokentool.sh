...
tokentool_help () {
    ...
    echo "    -confLocation <path>       : Path to the HCatServer's hive-site.xml (defaults to /home/y/libexec/hcat_server/conf/hive-site.xml)"
...
tokentool() {
    ...
    case $1 in
        ...
        CMD_LINE="$CMD_LINE $1"
        ;;
        -olderThan|--olderThan|-batchSize|--batchSize|-sleepTime|--sleepTime)
