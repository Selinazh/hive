...
public class AvroSerDe extends AbstractSerDe {
  ...
  protected boolean allowReadUsingMetastoreColumnSchema = true;
  ...
  public void initialize(Configuration configuration, Properties properties) throws SerDeException {
    ...
    if (properties.getProperty(AvroSerdeUtils.AvroTableProperties.SCHEMA_LITERAL.getPropName()) != null
      ...
      if (!allowReadUsingMetastoreColumnSchema) {
        throw new AvroSerdeException("SerDe initialization failed. avro.schema.literal and avro.schema.url not set!");
      }
