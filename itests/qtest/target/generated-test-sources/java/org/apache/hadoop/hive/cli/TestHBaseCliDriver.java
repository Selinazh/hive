...
public class TestHBaseCliDriver extends TestCase {
  ...
  public static class TestHBaseCliDriverAddTestFromQFiles implements QTestUtil.SuiteAddTestFunctor {
    public void addTestToSuite(TestSuite suite, Object setup, String tName) {
      suite.addTest(new TestHBaseCliDriver("testCliDriver_"+tName, (HBaseTestSetup)setup));
    }
  }
  ...
  protected void setUp() {
    ...
    try {
      qt = new HBaseQTestUtil((HIVE_ROOT + "hbase-handler/src/test/results/positive/"), (HIVE_ROOT + "itests/qtest/target/qfile-results/hbase-handler/positive/"), miniMR,
  ...
  public static Test suite() {
    ...
    QTestUtil.addTestsToSuiteFromQfileNames("/Users/selinaz/dev/branch-1.2-skewjoinNPE/hive/itests/qtest/target/generated-test-sources/java/org/apache/hadoop/hive/cli/TestHBaseCliDriverQFileNames.txt", qFilesToExecute,
      suite, setup, new TestHBaseCliDriverAddTestFromQFiles());
    return setup;
  }

  public void testCliDriver_tez_runtime_skewjoin_1() throws Exception {
    runTest("tez_runtime_skewjoin_1", "tez_runtime_skewjoin_1.q", (HIVE_ROOT + "hbase-handler/src/test/queries/positive/tez_runtime_skewjoin_1.q"));
  }
