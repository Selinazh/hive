...
public class TestContribNegativeCliDriver extends TestCase {
  ...
  public static class TestNegativeCliDriverAddTestFromQFiles implements QTestUtil.SuiteAddTestFunctor {
    public void addTestToSuite(TestSuite suite, Object setup, String tName) {
      suite.addTest(new TestContribNegativeCliDriver("testNegativeCliDriver_"+tName));
    }
  }
  ...
  public static Test suite() {
    ...
    QTestUtil.addTestsToSuiteFromQfileNames("/Users/selinaz/dev/branch-1.2-skewjoinNPE/hive/itests/qtest/target/generated-test-sources/java/org/apache/hadoop/hive/cli/TestContribNegativeCliDriverQFileNames.txt", qFilesToExecute,
  ...
  public void testNegativeCliDriver_tez_runtime_skewjoin_1() throws Exception {
    runTest("tez_runtime_skewjoin_1", "tez_runtime_skewjoin_1.q", (HIVE_ROOT + "contrib/src/test/queries/clientnegative/tez_runtime_skewjoin_1.q"));
  }
