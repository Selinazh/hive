...
public class TestHBaseMinimrCliDriver extends TestCase {
  ...
  public static class TestHBaseCliDriverAddTestFromQFiles implements QTestUtil.SuiteAddTestFunctor {
    public void addTestToSuite(TestSuite suite, Object setup, String tName) {
      suite.addTest(new TestHBaseMinimrCliDriver("testCliDriver_"+tName, (HBaseTestSetup)setup));
    }
  }
  ...
  protected void setUp() {
    ...
    try {
      qt = new HBaseQTestUtil((HIVE_ROOT + "hbase-handler/src/test/results/positive/"), (HIVE_ROOT + "itests/qtest/target/qfile-results/hbase-handler/minimrpositive/"), miniMR,
  ...
  public static Test suite() {
    ...
    QTestUtil.addTestsToSuiteFromQfileNames("/Users/selinaz/dev/branch-1.2-skewjoinNPE/hive/itests/qtest/target/generated-test-sources/java/org/apache/hadoop/hive/cli/TestHBaseMinimrCliDriverQFileNames.txt", qFilesToExecute,
