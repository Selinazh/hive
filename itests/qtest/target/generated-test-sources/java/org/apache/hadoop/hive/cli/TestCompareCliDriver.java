...
public class TestCompareCliDriver extends TestCase {
  ...
  public static class TestCompareCliDriverAddTestFromQFiles implements QTestUtil.SuiteAddTestFunctor {
    public void addTestToSuite(TestSuite suite, Object setup, String tName) {
      suite.addTest(new TestCompareCliDriver("testCompareCliDriver_"+tName));
    }
  }
  ...
  static {
    ...
    try {
      ...
      qt = new QTestUtil((HIVE_ROOT + "$resultsDir"), (HIVE_ROOT + "itests/qtest/target/qfile-results/clientcompare/"), miniMR,
  ...
  public static Test suite() {
    ...
    QTestUtil.addTestsToSuiteFromQfileNames("/Users/selinaz/dev/branch-1.2-skewjoinNPE/hive/itests/qtest/target/generated-test-sources/java/org/apache/hadoop/hive/cli/TestCompareCliDriverQFileNames.txt", qFilesToExecute,
  ...
  public void testCompareCliDriver_tez_runtime_skewjoin_1() throws Exception {
    runTest("tez_runtime_skewjoin_1", "tez_runtime_skewjoin_1.q", (HIVE_ROOT + "ql/src/test/queries/clientcompare/tez_runtime_skewjoin_1.q"));
  }
