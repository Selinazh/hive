...
public class TestParseNegative extends TestCase {
  ...
  public static class TestParseNegativeAddTestFromQFiles implements QTestUtil.SuiteAddTestFunctor {
    public void addTestToSuite(TestSuite suite, Object setup, String tName) {
      suite.addTest(new TestParseNegative("testParseNegative_"+tName));
    }
  }
  ...
  public static Test suite() {
    ...
    QTestUtil.addTestsToSuiteFromQfileNames("/Users/selinaz/dev/branch-1.2-skewjoinNPE/hive/itests/qtest/target/generated-test-sources/java/org/apache/hadoop/hive/ql/parse/TestParseNegativeQFileNames.txt", qFilesToExecute,
  ...
  public void testParseNegative_tez_runtime_skewjoin_1() throws Exception {
    runTest("tez_runtime_skewjoin_1", "tez_runtime_skewjoin_1.q", (HIVE_ROOT + "ql/src/test/queries/negative/tez_runtime_skewjoin_1.q"));
  }
