...
public class TestMiniTezCliDriver extends TestCase {
  ...
  public static class TestCliDriverAddTestFromQFiles implements QTestUtil.SuiteAddTestFunctor {
    public void addTestToSuite(TestSuite suite, Object setup, String tName) {
      suite.addTest(new TestMiniTezCliDriver("testCliDriver_"+tName));
    }
  }
  ...
  static {
    ...
    String hiveConfDir = "data/conf/tez/";
    ...
    try {
      ...
      qt = new QTestUtil((HIVE_ROOT + "ql/src/test/results/clientpositive/tez/"), (HIVE_ROOT + "itests/qtest/target/qfile-results/clientpositive/"), miniMR,
  ...
  public static Test suite() {
    ...
    QTestUtil.addTestsToSuiteFromQfileNames("/Users/selinaz/dev/branch-1.2-skewjoinNPE/hive/itests/qtest/target/generated-test-sources/java/org/apache/hadoop/hive/cli/TestMiniTezCliDriverQFileNames.txt", qFilesToExecute,
