...
public class TestContribCliDriver extends TestCase {
  ...
  public static class TestCliDriverAddTestFromQFiles implements QTestUtil.SuiteAddTestFunctor {
    public void addTestToSuite(TestSuite suite, Object setup, String tName) {
      suite.addTest(new TestContribCliDriver("testCliDriver_"+tName));
    }
  }
  ...
  static {
    ...
    try {
      ...
      qt = new QTestUtil((HIVE_ROOT + "contrib/src/test/results/clientpositive/"), (HIVE_ROOT + "itests/qtest/target/qfile-results/contribclientpositive/"), miniMR,
  ...
  public static Test suite() {
    ...
    QTestUtil.addTestsToSuiteFromQfileNames("/Users/selinaz/dev/branch-1.2-skewjoinNPE/hive/itests/qtest/target/generated-test-sources/java/org/apache/hadoop/hive/cli/TestContribCliDriverQFileNames.txt", qFilesToExecute,
  ...
  public void testCliDriver_tez_runtime_skewjoin_1() throws Exception {
    runTest("tez_runtime_skewjoin_1", "tez_runtime_skewjoin_1.q", (HIVE_ROOT + "contrib/src/test/queries/clientpositive/tez_runtime_skewjoin_1.q"));
  }
