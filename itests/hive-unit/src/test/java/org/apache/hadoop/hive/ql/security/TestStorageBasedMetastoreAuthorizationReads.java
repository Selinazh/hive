...
public class TestStorageBasedMetastoreAuthorizationReads extends StorageBasedMetastoreTestBase {
  ...
  private void readTableByOtherUser(String perm, boolean isSuccess) throws Exception {
    ...
    // These tests should for data discovery.
    testCmd(driver, "DESCRIBE  " + dbDotTable, true);
    testCmd(driver, "DESCRIBE EXTENDED  " + dbDotTable, true);
    testCmd(driver, "SHOW PARTITIONS  " + dbDotTable, true);
    testCmd(driver, "SHOW COLUMNS IN " + tblName + " IN " + dbName, true);
    testCmd(driver, "use " + dbName, true);
    testCmd(driver, "SHOW TABLE EXTENDED LIKE " + tblName, true);
  ...
  private void readDbByOtherUser(String perm, boolean isSuccess) throws Exception {
    ...
    // These tests should for data discovery.
    testCmd(driver, "DESCRIBE DATABASE " + dbName, true);
    testCmd(driver, "DESCRIBE DATABASE EXTENDED " + dbName, true);
    testCmd(driver, "SHOW TABLES IN " + dbName, true);
    driver.run("use " + dbName);
    testCmd(driver, "SHOW TABLES ", true);
