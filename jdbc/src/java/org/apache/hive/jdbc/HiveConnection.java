...
public class HiveConnection implements java.sql.Connection {
  ...
  /*
   * Return the low-level client for any non-JDBC admin activities. This is
   * the easiest way without touching too many places making future merges hard.
   */
  ...
  private void openSession() throws SQLException {
    ...
    try {
      ...
      if (sessHandle == null) {
        throw new SQLException("Could not establish connection to " + jdbcUriString + ": null session handle", "08S01");
      }
    } catch (TException e) {
