...
public class TezProcessor extends AbstractLogicalIOProcessor {
  ...
  public void run(Map<String, LogicalInput> inputs, Map<String, LogicalOutput> outputs)
      ...
      // leverage TEZ-3437: Improve synchronization and the progress report behavior, need Tez 0.7.1.15 or above.
      progressHelper = new ProgressHelper(inputs, getContext(), this.getClass().getSimpleName());
      if (isMap) {
