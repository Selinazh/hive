  ...
  public static void processVectorInspector(
    ...
    for(StructField field : fields) {
      ...
      try {
        ...
        // skip. this check is for all columns in the struct. No projected columns been pushed. since this
        // is runtime, all validation has been done, we could assume no illegal data types involved.
        writers[i] = null;
        oids.add(null);
      }
