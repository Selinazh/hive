...
public class AlterTableDesc extends DDLDesc implements Serializable {
  ...
  boolean isAddColsIfNotExists = false;
  ...
  /**
   * @return isAddColsIfNotExists
   */
  public boolean getIsAddColsIfNotExists() {
	  return isAddColsIfNotExists;
  }

  /**
   * @param isAddColsIfNotExists the isAddColsIfNotExists to set
   */
  public void setAddColsIfNotExists(boolean isAddColsIfExists) {
	  this.isAddColsIfNotExists = isAddColsIfExists;
  }
