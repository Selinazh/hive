...
public class MapJoinBytesTableContainer
  ...
  private class ReusableRowContainer
    ...
    private List<Object> uppack(WriteBuffers.ByteSegmentRef ref) throws HiveException {
      ...
      List<Object> result = new ArrayList<Object>(internalValueOi.getAllStructFieldRefs().size());
      ObjectInspectorUtils.copyToStandardObject(result, valueStruct, internalValueOi, ObjectInspectorCopyOption.WRITABLE);
      return result;
    }
