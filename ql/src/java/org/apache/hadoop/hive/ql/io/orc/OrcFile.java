...
import static org.apache.hadoop.hive.conf.HiveConf.ConfVars.HIVE_ORC_ENFORCE_COMPRESSION_BUFFER_SIZE;
...
public final class OrcFile {
  ...
  public static class WriterOptions {
    ...
    WriterOptions(Configuration conf) {
      ...
      enforceBufferSize = HiveConf.getBoolVar(conf, HIVE_ORC_ENFORCE_COMPRESSION_BUFFER_SIZE);
    }
  ...
  public static Writer createWriter(Path path,
    ...
    if (opts.memoryManagerValue == null) {
      opts.memory(getMemoryManager(opts.configuration));
    }
