...
public class ReduceSinkDesc extends AbstractOperatorDesc {
  ...
  // for skewed join
  private boolean keySkewed = false;
  private boolean isRePartitionSkewedKeyNeeded = false; // big table needs rehash skewed key
  private String skewedKeyDistPath;
  private List<String> skewedColTypes;
  private List<String> skewedColumns;

  public boolean isRePartitionNeeded() {
    return isRePartitionSkewedKeyNeeded;
  }

  public void setRePartitionNeeded(boolean rehash) {
    this.isRePartitionSkewedKeyNeeded = rehash;
  }
  ...
  public boolean hasSkewedKey() {
    return keySkewed;
  }

  public void setHasSkewedKey(boolean hasSkewedKey) {
    this.keySkewed = hasSkewedKey;
  }

  public String getSkewedKeyDistPath() {
    return skewedKeyDistPath;
  }

  public void setSkewedKeyDistPath(String skewedKeyDistPath) {
    this.skewedKeyDistPath = skewedKeyDistPath;
  }

  public List<String> getSkewedKeyType() {
    return skewedColTypes;
  }

  public void setSkewedKeyType(List<String> skewedColTypes) {
    this.skewedColTypes = skewedColTypes;
  }

  public List<String> getSkewedKeyCols() {
    return this.skewedColumns;
  }

  public void setSkewedKeyCols(List<String> skewedColumns) {
