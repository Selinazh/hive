...
public class MapRedTask extends ExecDriver implements Serializable {
  ...
  public int execute(DriverContext driverContext) {
    ...
    try {
      ...
      // create tmp file for metadataonly table scan
      String alias = work.getMapWork().getAliasToWork().keySet().iterator().next();
      Operator<? extends OperatorDesc> topOp = work.getMapWork().getAliasToWork().get(alias);
      Utilities.createTmpFileForMetadataOnlyTso(job, work.getMapWork(), topOp, alias);
