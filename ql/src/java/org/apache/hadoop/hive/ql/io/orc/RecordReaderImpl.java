...
class RecordReaderImpl implements RecordReader {
  ...
  private List<StripeInformation> filteredStripes;
  ...
  protected RecordReaderImpl(List<StripeInformation> stripes,
      List<StripeInformation> filteredStripes,
    ...
    this.filteredStripes = filteredStripes;
  ...
  private void readStripe() throws IOException {
    if (!filteredStripes.contains(stripes.get(currentStripe))) {
      rowCountInStripe = 0;
      rowInStripe = 0;
      rowBaseInStripe = 0;
