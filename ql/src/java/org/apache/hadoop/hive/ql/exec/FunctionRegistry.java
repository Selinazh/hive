...
import com.yahoo.sketches.hive.theta.DataToSketchUDAF;
...
import com.yahoo.sketches.hive.theta.MergeSketchUDAF;
import com.yahoo.sketches.hive.theta.SampleSketchUDF;
...
public final class FunctionRegistry {
  ...
  private static void registerBuiltInFunctions() {
    ...
    // Data sketch UDFs
    system.registerGenericUDAF("data_to_sketch", new DataToSketchUDAF());
    system.registerUDF("estimate_sketch", EstimateSketchUDF.class, false);
    system.registerUDF("exclude_sketch", ExcludeSketchUDF.class, false);
    system.registerUDF("intersect_sketch", IntersectSketchUDF.class, false);
    system.registerGenericUDAF("merge_sketch", new MergeSketchUDAF());
    system.registerUDF("sample_sketch", SampleSketchUDF.class, false);
    system.registerUDF("union_sketch", UnionSketchUDF.class, false);
  }
  ...
  public static FunctionInfo getFunctionInfo(String functionName) throws SemanticException {
    ...
    return info != null ? info : getSystemRegistry().getFunctionInfo(functionName);
  }
  ...
  public static WindowFunctionInfo getWindowFunctionInfo(String functionName)
    ...
    return info != null ? info : getSystemRegistry().getWindowFunctionInfo(functionName);
  }

  public static Set<String> getFunctionNames() {
    Set<String> names = new TreeSet<String>();
    names.addAll(getSystemRegistry().getCurrentFunctionNames());
  ...
  public static Set<String> getFunctionNames(String funcPatternStr) {
    ...
    funcNames.addAll(getSystemRegistry().getFunctionNames(funcPatternStr));
    if (SessionState.getRegistry() != null) {
  ...
  public static Set<String> getFunctionSynonyms(String funcName) throws SemanticException {
    ...
    getSystemRegistry().getFunctionSynonyms(funcName, funcInfo, synonyms);
    if (SessionState.getRegistry() != null) {
  ...
  public static GenericUDAFEvaluator getGenericWindowingEvaluator(String name,
    ...
    return evaluator != null ? evaluator :
      getSystemRegistry().getGenericWindowingEvaluator(name, argumentOIs, isDistinct, isAllColumns);
  }
  ...
  public static FunctionInfo registerPermanentFunction(String functionName,
    ...
    return getSystemRegistry().registerPermanentFunction(functionName, className, registerToSession, resources);
  }

  public static void unregisterPermanentFunction(String functionName) throws HiveException {
    getSystemRegistry().unregisterFunction(functionName);
  ...
  public static boolean isBuiltInFuncExpr(ExprNodeGenericFuncDesc fnExpr) {
    ...
    if (udfClass != null) {
      return getSystemRegistry().isBuiltInFunc(udfClass);
    }
    return false;
  }
  ...
  public static void setupPermissionsForBuiltinUDFs(String whiteListStr,
      String blackListStr) {
    getSystemRegistry().setupPermissionsForUDFs(whiteListStr, blackListStr);
  }
}
