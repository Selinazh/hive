...
public interface CompressionCodec {
   ...
   * Compress the in buffer to the out buffer.
   * @param in the bytes to compress
   * @param compressed dynamic growth buffer
   * @return
   * @throws IOException
   */
  boolean compress(ByteBuffer in, ChannelBuffer compressed) throws IOException;
   ...
   * @param in the bytes to decompress
   * @param out the decompressed bytes
   * @param maxBufferSize maximum out buffer can be allocated
   * @throws IOException
   */
  void decompress(ByteBuffer in, ChannelBuffer out, int maxBufferSize) throws IOException;
