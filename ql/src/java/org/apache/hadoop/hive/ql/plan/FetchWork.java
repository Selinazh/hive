...
public class FetchWork implements Serializable {
  ...
  public FetchWork(List<String> partitionNames, TableDesc tblDesc) {
    this.tblDesc = tblDesc;
    this.partDir = new ArrayList<Path>();
    this.partDesc = new ArrayList<PartitionDesc>();
    this.partNames = partitionNames;
  }
