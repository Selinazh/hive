...
import com.yahoo.sketches.hive.theta.vector.VectorUDAFDataToSketches;
/**
...
public class VectorizationContext {
  ...
  static ArrayList<AggregateDefinition> aggregatesDefinition = new ArrayList<AggregateDefinition>() {{
    ...
    add(new AggregateDefinition("data_to_sketch",VectorExpressionDescriptor.ArgumentType.STRING_FAMILY,          GroupByDesc.Mode.HASH,         VectorUDAFDataToSketches.class));
