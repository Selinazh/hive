...
nonReserved
    ...
    | KW_COMMENT | KW_COMPACT | KW_COMPACTIONS | KW_COMPUTE | KW_CONCATENATE | KW_CONF | KW_CONTINUE | KW_DATA | KW_DAY
...
sql11ReservedKeywordsUsedAsIdentifier
    ...
    | KW_GROUP | KW_GROUPING | KW_IMPORT | KW_IN | KW_INNER | KW_INSERT | KW_INT | KW_INTERSECT | KW_INTERVAL | KW_INTO | KW_IS | KW_LATERAL 
