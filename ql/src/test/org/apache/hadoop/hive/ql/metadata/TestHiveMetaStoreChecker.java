...
public class TestHiveMetaStoreChecker extends TestCase {
  ...
  public void testTableCheck() throws HiveException, MetaException,
    ...
    /* Internal patch won't remove the database directory if not empty. Clean up now to allow tearDown to work properly. */
    fs.delete(fakeTable);
  }
  ...
  public void testDataDeletion() throws HiveException, MetaException,
    ...
    /* Internal patch won't remove the database directory if not empty. */
    assertTrue(fs.exists(fakeTable));

    /* Clean up now to allow tearDown to work properly. */
    fs.delete(fakeTable);
  }
}
