...
public class TestOrcFile {
  ...
  public TestOrcFile(Boolean zcr, Boolean disableDictionary) {
    zeroCopy = zcr.booleanValue();
    this.disableDictionary = disableDictionary.booleanValue();
  }
  ...
  public void openFileSystem () throws Exception {
    ...
    conf.setBoolean(HiveConf.ConfVars.HIVE_ORC_DISABLE_DICTIONARY_COMPLEX_TYPES.varname, disableDictionary);
...
//    assertEquals(null,stats.getSum());
  ...
  public void testMemoryManagementV12() throws Exception {
    ...
    // with HIVE-10036, the fixed sized buffer is changed to dynamic buffer with the default init
    // capability 256, double sized the buffersize specified in this Writer. So got 6 stripes.
    assertEquals(6, i);
    assertEquals(2500, reader.getNumberOfRows());
  }
