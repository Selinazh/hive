...
insert into table TEST1 partition (ds='1') select cast(key as int), 2.1 from src where key <=10;
insert into table TEST1 partition (ds='2') select cast(key as int), 3.0 from src where key > 10;
