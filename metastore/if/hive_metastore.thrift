...
service ThriftHiveMetastore extends fb303.FacebookService
{
  ...
  // Searches all databases for any specific pattern
  SearchResponse search_tables(1:SearchRequest request) throws (1:MetaException o1)
  ...
  DropPartitionsResult drop_partitions_req(1: DropPartitionsRequest req)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
  void drop_and_add_partitions_req(1: DropPartitionsRequest drop_req, 2:AddPartitionsRequest add_req)
                       throws(1:NoSuchObjectException o1, 2:MetaException o2)
