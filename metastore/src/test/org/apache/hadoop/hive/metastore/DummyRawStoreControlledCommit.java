...
public class DummyRawStoreControlledCommit implements RawStore, Configurable {
  ...
  */
  ...
  public List<Table> listTablesByQuery(String[] keywords, long maxResults) throws MetaException {
    return objectStore.listTablesByQuery(keywords, maxResults);
  }
  ...
  public PartitionValuesResponse listPartitionValues(String db_name, String tbl_name, List<FieldSchema> cols,
    boolean applyDistinct, String filter, boolean ascending, List<FieldSchema> order,
  ...
  @Override
  public boolean canDropAllPartitions(String dbname, String name, boolean allowsql) throws MetaException,
      NoSuchObjectException {
    return objectStore.canDropAllPartitions(dbname, name, allowsql);
  }

  @Override
  public List<Path> dropAllPartitionsNoTxn(String dbname, String name, boolean checkLocation, boolean allowsql, Path tablePath) throws MetaException,
      NoSuchObjectException, InvalidObjectException, InvalidInputException {
    return objectStore.dropAllPartitionsNoTxn(dbname, name, checkLocation, allowsql, tablePath);
  }
