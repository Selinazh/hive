      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem376 = null;
              $elem376 = new \metastore\FieldSchema();
              $xfer += $elem376->read($input);
              $this->partitionKeys []= $elem376;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 6:
          if ($ftype == TType::LST) {
            ...
            {
              $elem382 = null;
              $elem382 = new \metastore\FieldSchema();
              $xfer += $elem382->read($input);
              $this->partitionOrder []= $elem382;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->partitionKeys !== null) {
      ...
      $xfer += $output->writeFieldBegin('partitionKeys', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRUCT, count($this->partitionKeys));
        {
          foreach ($this->partitionKeys as $iter383)
          {
    ...
    if ($this->partitionOrder !== null) {
      ...
      $xfer += $output->writeFieldBegin('partitionOrder', TType::LST, 6);
      {
        ...
        {
          foreach ($this->partitionOrder as $iter384)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem397 = null;
              $elem397 = new \metastore\PartitionValuesRow();
              $xfer += $elem397->read($input);
              $this->partitionValues []= $elem397;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->partitionValues !== null) {
      ...
      $xfer += $output->writeFieldBegin('partitionValues', TType::LST, 1);
      {
        ...
        {
          foreach ($this->partitionValues as $iter398)
          {
...
class SearchRequest {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::I64) {
            $xfer += $input->readI64($this->maxResults);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->maxResults !== null) {
      $xfer += $output->writeFieldBegin('maxResults', TType::I64, 2);
      $xfer += $output->writeI64($this->maxResults);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
  ...
  public function write($output) {
    ...
    if ($this->tables !== null) {
      ...
      $xfer += $output->writeFieldBegin('tables', TType::LST, 1);
      {
        ...
        {
          foreach ($this->tables as $iter405)
          {
      ...
      switch ($fid)
      {
        ...
        case 8:
          if ($ftype == TType::LST) {
            ...
            {
              $elem411 = null;
              $elem411 = new \metastore\ResourceUri();
              $xfer += $elem411->read($input);
              $this->resourceUris []= $elem411;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->resourceUris !== null) {
      ...
      $xfer += $output->writeFieldBegin('resourceUris', TType::LST, 8);
      {
        ...
        {
          foreach ($this->resourceUris as $iter412)
          {
          ...
          if ($ftype == TType::SET) {
            ...
            for ($_i424 = 0; $_i424 < $_size420; ++$_i424)
            {
              ...
              if (is_scalar($elem425)) {
                $this->open_txns[$elem425] = true;
              } else {
                $this->open_txns []= $elem425;
              }
            }
  ...
  public function write($output) {
    ...
    if ($this->open_txns !== null) {
      ...
      $xfer += $output->writeFieldBegin('open_txns', TType::SET, 2);
      {
        ...
        {
          foreach ($this->open_txns as $iter426 => $iter427)
          {
