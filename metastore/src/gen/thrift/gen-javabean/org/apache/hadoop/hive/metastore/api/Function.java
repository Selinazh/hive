            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resourceUris = new ArrayList<ResourceUri>(_list460.size);
                ResourceUri _elem461;
                for (int _i462 = 0; _i462 < _list460.size; ++_i462)
                {
                  _elem461 = new ResourceUri();
                  _elem461.read(iprot);
                  struct.resourceUris.add(_elem461);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Function struct) throws org.apache.thrift.TException {
      ...
      if (struct.resourceUris != null) {
        oprot.writeFieldBegin(RESOURCE_URIS_FIELD_DESC);
        {
          ...
          for (ResourceUri _iter463 : struct.resourceUris)
          {
      ...
      if (struct.isSetResourceUris()) {
        {
          ...
          for (ResourceUri _iter464 : struct.resourceUris)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.resourceUris = new ArrayList<ResourceUri>(_list465.size);
          ResourceUri _elem466;
          for (int _i467 = 0; _i467 < _list465.size; ++_i467)
          {
            _elem466 = new ResourceUri();
            _elem466.read(iprot);
            struct.resourceUris.add(_elem466);
          }
        }
        struct.setResourceUrisIsSet(true);
      }
