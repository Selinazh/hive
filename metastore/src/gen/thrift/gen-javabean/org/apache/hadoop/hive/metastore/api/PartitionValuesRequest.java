            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionKeys = new ArrayList<FieldSchema>(_list420.size);
                FieldSchema _elem421;
                for (int _i422 = 0; _i422 < _list420.size; ++_i422)
                {
                  _elem421 = new FieldSchema();
                  _elem421.read(iprot);
                  struct.partitionKeys.add(_elem421);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionOrder = new ArrayList<FieldSchema>(_list423.size);
                FieldSchema _elem424;
                for (int _i425 = 0; _i425 < _list423.size; ++_i425)
                {
                  _elem424 = new FieldSchema();
                  _elem424.read(iprot);
                  struct.partitionOrder.add(_elem424);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitionValuesRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionKeys != null) {
        oprot.writeFieldBegin(PARTITION_KEYS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter426 : struct.partitionKeys)
          {
      ...
      if (struct.partitionOrder != null) {
        if (struct.isSetPartitionOrder()) {
          oprot.writeFieldBegin(PARTITION_ORDER_FIELD_DESC);
          {
            ...
            for (FieldSchema _iter427 : struct.partitionOrder)
            {
  ...
  private static class PartitionValuesRequestTupleScheme extends TupleScheme<PartitionValuesRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PartitionValuesRequest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.tblName);
      {
        ...
        for (FieldSchema _iter428 : struct.partitionKeys)
        {
      ...
      if (struct.isSetPartitionOrder()) {
        {
          ...
          for (FieldSchema _iter429 : struct.partitionOrder)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PartitionValuesRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTblNameIsSet(true);
      {
        ...
        struct.partitionKeys = new ArrayList<FieldSchema>(_list430.size);
        FieldSchema _elem431;
        for (int _i432 = 0; _i432 < _list430.size; ++_i432)
        {
          _elem431 = new FieldSchema();
          _elem431.read(iprot);
          struct.partitionKeys.add(_elem431);
        }
      }
      struct.setPartitionKeysIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partitionOrder = new ArrayList<FieldSchema>(_list433.size);
          FieldSchema _elem434;
          for (int _i435 = 0; _i435 < _list433.size; ++_i435)
          {
            _elem434 = new FieldSchema();
            _elem434.read(iprot);
            struct.partitionOrder.add(_elem434);
          }
        }
        struct.setPartitionOrderIsSet(true);
      }
