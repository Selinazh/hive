...
class ThriftHiveMetastoreIf : virtual public  ::facebook::fb303::FacebookServiceIf {
 public:
  ...
  virtual void search_tables(SearchResponse& _return, const SearchRequest& request) = 0;
  ...
  virtual void drop_and_add_partitions_req(const DropPartitionsRequest& drop_req, const AddPartitionsRequest& add_req) = 0;
...
class ThriftHiveMetastoreNull : virtual public ThriftHiveMetastoreIf , virtual public  ::facebook::fb303::FacebookServiceNull {
 public:
  ...
  void search_tables(SearchResponse& /* _return */, const SearchRequest& /* request */) {
    return;
  }
  ...
  void drop_and_add_partitions_req(const DropPartitionsRequest& /* drop_req */, const AddPartitionsRequest& /* add_req */) {
    return;
  }
...
typedef struct _ThriftHiveMetastore_search_tables_args__isset {
  _ThriftHiveMetastore_search_tables_args__isset() : request(false) {}
  bool request :1;
} _ThriftHiveMetastore_search_tables_args__isset;

class ThriftHiveMetastore_search_tables_args {
 public:

  ThriftHiveMetastore_search_tables_args(const ThriftHiveMetastore_search_tables_args&);
  ThriftHiveMetastore_search_tables_args& operator=(const ThriftHiveMetastore_search_tables_args&);
  ThriftHiveMetastore_search_tables_args() {
  }

  virtual ~ThriftHiveMetastore_search_tables_args() throw();
  SearchRequest request;

  _ThriftHiveMetastore_search_tables_args__isset __isset;

  void __set_request(const SearchRequest& val);

  bool operator == (const ThriftHiveMetastore_search_tables_args & rhs) const
  {
  ...
  bool operator < (const ThriftHiveMetastore_search_tables_args & ) const;
...
class ThriftHiveMetastore_search_tables_pargs {
 public:


  virtual ~ThriftHiveMetastore_search_tables_pargs() throw();
...
typedef struct _ThriftHiveMetastore_search_tables_result__isset {
  _ThriftHiveMetastore_search_tables_result__isset() : success(false), o1(false) {}
  bool success :1;
  bool o1 :1;
} _ThriftHiveMetastore_search_tables_result__isset;

class ThriftHiveMetastore_search_tables_result {
 public:

  ThriftHiveMetastore_search_tables_result(const ThriftHiveMetastore_search_tables_result&);
  ThriftHiveMetastore_search_tables_result& operator=(const ThriftHiveMetastore_search_tables_result&);
  ThriftHiveMetastore_search_tables_result() {
  }

  virtual ~ThriftHiveMetastore_search_tables_result() throw();
  SearchResponse success;
  MetaException o1;

  _ThriftHiveMetastore_search_tables_result__isset __isset;

  void __set_success(const SearchResponse& val);

  void __set_o1(const MetaException& val);

  bool operator == (const ThriftHiveMetastore_search_tables_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(o1 == rhs.o1))
  ...
  bool operator < (const ThriftHiveMetastore_search_tables_result & ) const;
...
typedef struct _ThriftHiveMetastore_search_tables_presult__isset {
  _ThriftHiveMetastore_search_tables_presult__isset() : success(false), o1(false) {}
  bool success :1;
  bool o1 :1;
} _ThriftHiveMetastore_search_tables_presult__isset;

class ThriftHiveMetastore_search_tables_presult {
 public:


  virtual ~ThriftHiveMetastore_search_tables_presult() throw();
  SearchResponse* success;
  MetaException o1;

  _ThriftHiveMetastore_search_tables_presult__isset __isset;
...
typedef struct _ThriftHiveMetastore_drop_and_add_partitions_req_args__isset {
  _ThriftHiveMetastore_drop_and_add_partitions_req_args__isset() : drop_req(false), add_req(false) {}
  bool drop_req :1;
  bool add_req :1;
} _ThriftHiveMetastore_drop_and_add_partitions_req_args__isset;

class ThriftHiveMetastore_drop_and_add_partitions_req_args {
 public:

  ThriftHiveMetastore_drop_and_add_partitions_req_args(const ThriftHiveMetastore_drop_and_add_partitions_req_args&);
  ThriftHiveMetastore_drop_and_add_partitions_req_args& operator=(const ThriftHiveMetastore_drop_and_add_partitions_req_args&);
  ThriftHiveMetastore_drop_and_add_partitions_req_args() {
  }

  virtual ~ThriftHiveMetastore_drop_and_add_partitions_req_args() throw();
  DropPartitionsRequest drop_req;
  AddPartitionsRequest add_req;

  _ThriftHiveMetastore_drop_and_add_partitions_req_args__isset __isset;

  void __set_drop_req(const DropPartitionsRequest& val);

  void __set_add_req(const AddPartitionsRequest& val);

  bool operator == (const ThriftHiveMetastore_drop_and_add_partitions_req_args & rhs) const
  {
    if (!(drop_req == rhs.drop_req))
      return false;
    if (!(add_req == rhs.add_req))
      return false;
    return true;
  }
  bool operator != (const ThriftHiveMetastore_drop_and_add_partitions_req_args &rhs) const {
  ...
  bool operator < (const ThriftHiveMetastore_drop_and_add_partitions_req_args & ) const;
...
class ThriftHiveMetastore_drop_and_add_partitions_req_pargs {
 public:


  virtual ~ThriftHiveMetastore_drop_and_add_partitions_req_pargs() throw();
  const DropPartitionsRequest* drop_req;
  const AddPartitionsRequest* add_req;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _ThriftHiveMetastore_drop_and_add_partitions_req_result__isset {
  _ThriftHiveMetastore_drop_and_add_partitions_req_result__isset() : o1(false), o2(false) {}
  bool o1 :1;
  bool o2 :1;
} _ThriftHiveMetastore_drop_and_add_partitions_req_result__isset;

class ThriftHiveMetastore_drop_and_add_partitions_req_result {
 public:

  ThriftHiveMetastore_drop_and_add_partitions_req_result(const ThriftHiveMetastore_drop_and_add_partitions_req_result&);
  ThriftHiveMetastore_drop_and_add_partitions_req_result& operator=(const ThriftHiveMetastore_drop_and_add_partitions_req_result&);
  ThriftHiveMetastore_drop_and_add_partitions_req_result() {
  }

  virtual ~ThriftHiveMetastore_drop_and_add_partitions_req_result() throw();
  NoSuchObjectException o1;
  MetaException o2;

  _ThriftHiveMetastore_drop_and_add_partitions_req_result__isset __isset;

  void __set_o1(const NoSuchObjectException& val);

  void __set_o2(const MetaException& val);

  bool operator == (const ThriftHiveMetastore_drop_and_add_partitions_req_result & rhs) const
  {
    if (!(o1 == rhs.o1))
      return false;
    if (!(o2 == rhs.o2))
  ...
  bool operator < (const ThriftHiveMetastore_drop_and_add_partitions_req_result & ) const;
...
typedef struct _ThriftHiveMetastore_drop_and_add_partitions_req_presult__isset {
  _ThriftHiveMetastore_drop_and_add_partitions_req_presult__isset() : o1(false), o2(false) {}
  bool o1 :1;
  bool o2 :1;
} _ThriftHiveMetastore_drop_and_add_partitions_req_presult__isset;

class ThriftHiveMetastore_drop_and_add_partitions_req_presult {
 public:


  virtual ~ThriftHiveMetastore_drop_and_add_partitions_req_presult() throw();
  NoSuchObjectException o1;
  MetaException o2;

  _ThriftHiveMetastore_drop_and_add_partitions_req_presult__isset __isset;
...
class ThriftHiveMetastoreClient : virtual public ThriftHiveMetastoreIf, public  ::facebook::fb303::FacebookServiceClient {
 public:
  ...
  void search_tables(SearchResponse& _return, const SearchRequest& request);
  void send_search_tables(const SearchRequest& request);
  void recv_search_tables(SearchResponse& _return);
  void alter_table(const std::string& dbname, const std::string& tbl_name, const Table& new_tbl);
  ...
  void drop_and_add_partitions_req(const DropPartitionsRequest& drop_req, const AddPartitionsRequest& add_req);
  void send_drop_and_add_partitions_req(const DropPartitionsRequest& drop_req, const AddPartitionsRequest& add_req);
  void recv_drop_and_add_partitions_req();
  void get_partition(Partition& _return, const std::string& db_name, const std::string& tbl_name, const std::vector<std::string> & part_vals);
...
class ThriftHiveMetastoreProcessor : public  ::facebook::fb303::FacebookServiceProcessor {
 ...
 private:
  ...
  void process_search_tables(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_drop_and_add_partitions_req(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  ThriftHiveMetastoreProcessor(boost::shared_ptr<ThriftHiveMetastoreIf> iface) :
    ...
    processMap_["search_tables"] = &ThriftHiveMetastoreProcessor::process_search_tables;
    ...
    processMap_["drop_and_add_partitions_req"] = &ThriftHiveMetastoreProcessor::process_drop_and_add_partitions_req;
...
class ThriftHiveMetastoreMultiface : virtual public ThriftHiveMetastoreIf, public  ::facebook::fb303::FacebookServiceMultiface {
 ...
 public:
  ...
  void search_tables(SearchResponse& _return, const SearchRequest& request) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->search_tables(_return, request);
    }
    ifaces_[i]->search_tables(_return, request);
    return;
  }
  ...
  void drop_and_add_partitions_req(const DropPartitionsRequest& drop_req, const AddPartitionsRequest& add_req) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->drop_and_add_partitions_req(drop_req, add_req);
    }
    ifaces_[i]->drop_and_add_partitions_req(drop_req, add_req);
  }
...
class ThriftHiveMetastoreConcurrentClient : virtual public ThriftHiveMetastoreIf, public  ::facebook::fb303::FacebookServiceConcurrentClient {
 public:
  ...
  void search_tables(SearchResponse& _return, const SearchRequest& request);
  int32_t send_search_tables(const SearchRequest& request);
  void recv_search_tables(SearchResponse& _return, const int32_t seqid);
  void alter_table(const std::string& dbname, const std::string& tbl_name, const Table& new_tbl);
  ...
  void drop_and_add_partitions_req(const DropPartitionsRequest& drop_req, const AddPartitionsRequest& add_req);
  int32_t send_drop_and_add_partitions_req(const DropPartitionsRequest& drop_req, const AddPartitionsRequest& add_req);
  void recv_drop_and_add_partitions_req(const int32_t seqid);
  void get_partition(Partition& _return, const std::string& db_name, const std::string& tbl_name, const std::vector<std::string> & part_vals);
