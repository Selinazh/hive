...
typedef struct _SearchRequest__isset {
  _SearchRequest__isset() : maxResults(true) {}
  bool maxResults :1;
...
class SearchRequest {
 public:
  ...
  SearchRequest() : query(), maxResults(-1LL) {
  }
  ...
  void __set_maxResults(const int64_t val);

  bool operator == (const SearchRequest & rhs) const
  {
    if (!(query == rhs.query))
      return false;
    if (__isset.maxResults != rhs.__isset.maxResults)
      return false;
    else if (__isset.maxResults && !(maxResults == rhs.maxResults))
      return false;
    return true;
  }
  bool operator != (const SearchRequest &rhs) const {
...
inline std::ostream& operator<<(std::ostream& out, const SearchRequest& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const SearchResponse& obj)
{
  obj.printTo(out);
  return out;
}
