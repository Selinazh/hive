...
module ThriftHiveMetastore
  class Client < ::FacebookService::Client 
    ...
    def search_tables(request)
      send_search_tables(request)
      return recv_search_tables()
    end

    def send_search_tables(request)
      send_message('search_tables', Search_tables_args, :request => request)
    end

    def recv_search_tables()
      result = receive_message(Search_tables_result)
      return result.success unless result.success.nil?
      raise result.o1 unless result.o1.nil?
      raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'search_tables failed: unknown result')
    end
    ...
    def drop_and_add_partitions_req(drop_req, add_req)
      send_drop_and_add_partitions_req(drop_req, add_req)
      recv_drop_and_add_partitions_req()
    end

    def send_drop_and_add_partitions_req(drop_req, add_req)
      send_message('drop_and_add_partitions_req', Drop_and_add_partitions_req_args, :drop_req => drop_req, :add_req => add_req)
    end

    def recv_drop_and_add_partitions_req()
      result = receive_message(Drop_and_add_partitions_req_result)
      raise result.o1 unless result.o1.nil?
      raise result.o2 unless result.o2.nil?
      return
    end
  ...
  class Processor < ::FacebookService::Processor 
    ...
    def process_search_tables(seqid, iprot, oprot)
      args = read_args(iprot, Search_tables_args)
      result = Search_tables_result.new()
      begin
        result.success = @handler.search_tables(args.request)
      rescue ::MetaException => o1
        result.o1 = o1
      end
      write_result(result, oprot, 'search_tables', seqid)
    end
    ...
    def process_drop_and_add_partitions_req(seqid, iprot, oprot)
      args = read_args(iprot, Drop_and_add_partitions_req_args)
      result = Drop_and_add_partitions_req_result.new()
      begin
        @handler.drop_and_add_partitions_req(args.drop_req, args.add_req)
      rescue ::NoSuchObjectException => o1
        result.o1 = o1
      rescue ::MetaException => o2
        result.o2 = o2
      end
      write_result(result, oprot, 'drop_and_add_partitions_req', seqid)
    end
  ...
  class Search_tables_args
    include ::Thrift::Struct, ::Thrift::Struct_Union
    REQUEST = 1

    FIELDS = {
      REQUEST => {:type => ::Thrift::Types::STRUCT, :name => 'request', :class => ::SearchRequest}
    }
  ...
  class Search_tables_result
    include ::Thrift::Struct, ::Thrift::Struct_Union
    SUCCESS = 0
    O1 = 1

    FIELDS = {
      SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::SearchResponse},
      O1 => {:type => ::Thrift::Types::STRUCT, :name => 'o1', :class => ::MetaException}
    }
  ...
  class Drop_and_add_partitions_req_args
    include ::Thrift::Struct, ::Thrift::Struct_Union
    DROP_REQ = 1
    ADD_REQ = 2

    FIELDS = {
      DROP_REQ => {:type => ::Thrift::Types::STRUCT, :name => 'drop_req', :class => ::DropPartitionsRequest},
      ADD_REQ => {:type => ::Thrift::Types::STRUCT, :name => 'add_req', :class => ::AddPartitionsRequest}
    }
  ...
  class Drop_and_add_partitions_req_result
    include ::Thrift::Struct, ::Thrift::Struct_Union
    O1 = 1
    O2 = 2
