...
public interface IMetaStoreClient {
  ...
  /**
   * Searches metastore for tables that match query
   *
   * @param query
   *          The query used to search metastore
   * @return
   *           A list of table objects that match the query
   * @throws MetaException
   *           Could not search tables
   * @throws TException
   *           A thrift communication error occurred
   */
  public List<Table> listTablesByQuery(String query, long maxResults)
  ...
  void dropAndAddPartitions(String dbName, String tblName,
                            List<ObjectPair<Integer, byte[]>> dropPartitionExprs, PartitionDropOptions dropOptions,
