...
public interface RawStore extends Configurable {
  ...
  public abstract List<Table> listTablesByQuery(String[] keywords, long maxResults) throws MetaException;
  ...
  public abstract boolean canDropAllPartitions(String dbname, String name, boolean allowsql) throws MetaException, NoSuchObjectException;

  public abstract List<Path> dropAllPartitionsNoTxn(String dbname, String name, boolean checkLocation, boolean allowsql, Path tablePath) throws MetaException, NoSuchObjectException, InvalidObjectException, InvalidInputException;
