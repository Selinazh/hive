...
public class TestHCatStorerWrapper extends HCatBaseTest {
  ...
  public void testStoreExternalTableWithExternalDir() throws IOException, CommandNeedRetryException{
    ...
    /*
     * Since the default HCatStorer behavior has changed, we have to set this property explicitly
     */
    Assert.assertEquals(0, driver.run("alter table junit_external set tblproperties ('immutable'='false')").getResponseCode());
