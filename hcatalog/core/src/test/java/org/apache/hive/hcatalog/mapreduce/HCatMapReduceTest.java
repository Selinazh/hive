...
public abstract class HCatMapReduceTest extends HCatBaseTest {
  ...
  protected boolean isTableImmutable() {
    return getConfiguration().getBoolean(HCatConstants.HCAT_TABLE_OUTPUT_IMMUTABLE,
  ...
  protected void setConfiguration() {
    ...
    configuration.setBoolean(HCatConstants.HCAT_HIVE_CLIENT_DISABLE_CACHE, true);
    configuration.setBoolean(HiveConf.ConfVars.METASTORE_INTEGER_JDO_PUSHDOWN.varname,true);
  }
