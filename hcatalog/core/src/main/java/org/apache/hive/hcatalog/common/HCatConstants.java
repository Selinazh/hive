...
public final class HCatConstants {
  ...
  public static final String HCAT_PIG_LOADER_PREDICATE_PUSHDOWN_ENABLED
      = HCAT_PIG_LOADER + ".predicate.pushdown.enabled";
  ...
  /**
   * {@value} (default: {@value #HCAT_TABLE_OUTPUT_DEFAULT_IMMUTABLE}).
   * Default behavior of HCatStorer/HCatOutputFormat when immutable property is not set in table
   * properties.
   */
  public static final String HCAT_TABLE_OUTPUT_IMMUTABLE = "hcat.output.default.immutable.behavior";
  public static final boolean HCAT_TABLE_OUTPUT_DEFAULT_IMMUTABLE = true;
}
