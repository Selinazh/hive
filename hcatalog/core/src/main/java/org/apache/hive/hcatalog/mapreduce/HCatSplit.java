...
public class HCatSplit extends InputSplit
  ...
  public String toString() {
    HCatTableInfo table = (partitionInfo == null ? null : partitionInfo.getTableInfo());

    return "HCatSplit {"
      +  "table : "
      + (table == null ? null : table.getDatabaseName() + "." + table.getTableName())
      +  ", partValues : " + (partitionInfo == null? null : partitionInfo.getPartitionValues())
      +  ", baseSplit : " + baseMapRedSplit
      +  "}";
  }
}
